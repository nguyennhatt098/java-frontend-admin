import { OnInit, ElementRef, RendererFactory2, AfterViewInit, OnDestroy, EventEmitter } from '@angular/core';
...
export declare class TableComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(thisElement: ElementRef, rendererFactory: RendererFactory2, dataService: DataService, validationService: ValidationService, excelExporterService: IgxExcelExporterService, actionService: ActionService);
    ngOnInit(): void;
    ...
    resetChanges(): void;
    changeEditor(value: string, item: any, field: string, index: number, ref?: any, validationOption?: ValidationOption, callback?: (item: any, field: string) => any): void;
    acceptInlineEdit(item: any, field: string, index: number, ref?: any, validationOption?: ValidationOption, callback?: (item: any, field: string) => any, autoClose?: boolean): void;
    ...
    filterByColumn(status: boolean): void;
